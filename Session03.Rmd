...
GO_results <- enrichGO(gene = genes_to_test, OrgDb = "org.Hs.eg.db", keyType = 'ENSEMBL', ont = "MF")
...
Final Exercise: 
Subset the 100 most expressed genes (in terms of logfold and p value) and generate a three GO plots based on BP, MF, CC. Select Print a GSEA figure of the most abundant GO from each of these classes. 
