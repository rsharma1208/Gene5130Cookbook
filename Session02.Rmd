...
```{r}
##find another way to import data into DESeq2
...
**Write your thoughts here:** we decided to remove low counts because with many comparisons, we will get reads that may be relevant by chance
